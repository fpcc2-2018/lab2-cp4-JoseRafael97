...
A figura 4 mostra uma alta concentação de sessões com tempo médio de sessão entre 10 e 1000 segundos em ambos os grupos. Já quando em relação aos número de cliques o grupo a possui sua concentração maior entre 0 e 20 cliques e no grupo b este valor fica entre 0 a 3 cliques em sua maior concentração.
